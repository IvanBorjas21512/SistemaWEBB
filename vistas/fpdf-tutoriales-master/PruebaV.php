...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Cell(110, 15, utf8_decode('ESTUDIO'), 1, 1, 'C', 0); // AnchoCelda,AltoCelda,titulo,borde(1-0),saltoLinea(1-0),posicion(L-C-R),ColorFondo(1-0)
      ...
      $this->Cell(100, 10, utf8_decode("REPORTES"), 0, 1, 'C', 0);
      $this->Ln(7);
